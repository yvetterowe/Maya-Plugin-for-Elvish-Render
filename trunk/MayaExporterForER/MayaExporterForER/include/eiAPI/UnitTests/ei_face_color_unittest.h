...
class ei_face_color_unittest : public CxxTest::TestSuite
{
public:
	void setUp();
	void tearDown();
...
void ei_face_color_unittest::setUp()
{
}

void ei_face_color_unittest::tearDown()
{
}

void ei_face_color_unittest::testBasic()
{
	renderApprox(NULL, "basic");
}

void ei_face_color_unittest::testTessellated()
{
	eiApprox	approx;
...
void ei_face_color_unittest::renderApprox(const eiApprox *approx, const char *suffix)
{
