...
class ei_scene_unittest : public CxxTest::TestSuite
{
public:
	void setUp();
	void tearDown();
...
void ei_scene_unittest::setUp()
{
}

void ei_scene_unittest::tearDown()
{
}

void ei_scene_unittest::testOverall()
{
	...
	ei_camera("cam1");
		ei_append_filename(output_filename, cur_dir, "frame02.bmp");
		ei_output(output_filename, "bmp", EI_IMG_DATA_RGB);
			ei_output_variable("color", EI_DATA_TYPE_VECTOR);
		ei_end_output();
		ei_aperture(100.0f);
