...
class ei_approx_viewdep_unittest : public CxxTest::TestSuite
{
public:
	void setUp();
	void tearDown();
...
private:
	void renderApprox(const eiApprox *approx, const char *suffix);
};

void ei_approx_viewdep_unittest::setUp()
{
}

void ei_approx_viewdep_unittest::tearDown()
{
}

void ei_approx_viewdep_unittest::testRegular()
{
	eiApprox	approx;
	...
	approx.args[ EI_APPROX_U ] = 5.0f;
	approx.args[ EI_APPROX_V ] = 5.0f;
	approx.motion_factor = 16.0f;

	renderApprox(&approx, "regular");
}

void ei_approx_viewdep_unittest::testLength()
{
	eiApprox	approx;
	...
	approx.args[ EI_APPROX_LENGTH ] = 20.0f;
	approx.motion_factor = 16.0f;

	renderApprox(&approx, "length");
}

void ei_approx_viewdep_unittest::testLengthFine()
{
	eiApprox	approx;
	...
	renderApprox(&approx, "length_fine");
}

void ei_approx_viewdep_unittest::renderApprox(const eiApprox *approx, const char *suffix)
{
	...
	ei_camera("cam1");
		sprintf(filename, "frame_approx_viewdep_%s01.bmp", suffix);
	...
	ei_shader("displace_shader");
		...
		ei_shader_param_scalar("disp_dist", 2.0f);
	ei_end_shader();
