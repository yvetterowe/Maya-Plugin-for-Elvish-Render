...
typedef struct eiState {
	...
	eiVector					dPdv;
	/* the derivative of surface position along raster x */
	eiVector					dPdx;
	/* the derivative of surface position along raster y */
	eiVector					dPdy;
	...
	eiMatrix2					duv;
	/* the change in surface parametric u coordinate along raster x */
	eiScalar					dudx;
	/* the change in surface parametric u coordinate along raster y */
	eiScalar					dudy;
	/* the change in surface parametric v coordinate along raster x */
	eiScalar					dvdx;
	/* the change in surface parametric v coordinate along raster y */
	eiScalar					dvdy;
...
/** \brief Compute derivatives along surface parametric coordinate u */
void deriv_u_any(
	eiByte * const dXdu, 
	const eiByte *dX1, 
	const eiByte *dX2, 
	eiState * const state, 
	const eiInt type);
/** \brief Compute derivatives along surface parametric coordinate v */
void deriv_v_any(
	eiByte * const dXdv, 
	const eiByte *dX1, 
	const eiByte *dX2, 
