...
\internal
\ingroup cloth
\brief Interface for cloth solver collision rigid body.
...
public:
	...
	virtual void updateDynFrictionMultiplier( const MIntArray& faces, double val ) = 0;
	virtual void updateStaticFrictionMultiplier( const MIntArray& faces, double val ) = 0;
	virtual void updateCollisionOffset( double offset[] ) = 0;
	virtual void updateCollisionDepth( double depth[] ) = 0;
	virtual void updateCollisionOffset( const MIntArray& faces, double offset[] ) = 0;
	virtual void updateCollisionDepth( const MIntArray& faces, double depth[] ) = 0;
...
//! \brief Pointer to an MClothPolyhedron.
