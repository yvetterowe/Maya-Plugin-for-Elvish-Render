...
class ei_displace_unittest : public CxxTest::TestSuite
{
public:
	void setUp();
	void tearDown();
...
void ei_displace_unittest::setUp()
{
}

void ei_displace_unittest::tearDown()
{
}

void ei_displace_unittest::testRegular()
{
	eiApprox	approx;
...
void ei_displace_unittest::testLength()
{
	eiApprox	approx;
...
void ei_displace_unittest::renderApprox(const eiApprox *approx, const char *suffix)
{
